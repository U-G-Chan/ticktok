...
const menuItems = [
  ...
  { text: '充值中心', icon: 'icon-currency' },
  { text: '券红包', icon: 'icon-red-envelope' },
  { text: 'TiTo超市', icon: 'icon-booth' },
  { text: '小时达', icon: 'icon-express-delivery' },
  { text: '国家补贴', icon: 'icon-coupon' },
  { text: '品牌馆', icon: 'icon-buy' },
  ...
  { text: '限时秒杀', icon: 'icon-hourglass-full' },
  { text: '满减活动', icon: 'icon-coupon' },
  { text: '借钱', icon: 'icon-bank' },
  { text: '游戏', icon: 'icon-game-handle' },
